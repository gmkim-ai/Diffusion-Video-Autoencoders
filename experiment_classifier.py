...
class ClsModel(pl.LightningModule):
    def __init__(self, conf: TrainConfig):
        ...
        if conf.train_mode == TrainMode.manipulate:
            ...
            if conf.manipulate_znormalize:
                ...
                print(self.conds.shape)
                # print(self.conds_mean, self.conds_std)
            else:
    ...
    def load_dataset(self):
        if self.conf.manipulate_mode == ManipulateMode.celebahq_all:
    ...
    def training_step(self, batch, batch_idx):
        ...
        if self.conf.train_mode == TrainMode.manipulate:
            ...
            with torch.no_grad():
                # (n, c)
                feats, cond = self.ema_model.encoder(imgs, return_id_feats=True)
